...
export default function App({ Component, pageProps }){
  ...
  return <div>
    <div className=" center" style={{justifyContent:"end",height:'50px',width:"100vw",position:"fixed",backgroundColor:"purple",color:"white",zIndex:"100",top:"0px",paddingRight:"10px"}}>
