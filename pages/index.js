  ...
  return (
    <div>
      ...
      {loaded ? <div className="center column" ><div className="first name" style={{color:"navy",position:"relative",right:"30px"}} >
        ...
        <div className=" title name" style={{backgroundColor:"green",color:"white",position:"relative",bottom:"38px",fontSize:"40px",padding:"10px 70px"}}  >
          E-portfolio 
        </div></div>:<div className=" section center intro name">Welcome</div>}
      </div>
