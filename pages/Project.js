    ...
    <div className="center column" style={{fontSize:"25px",fontWeight:"bolder"}} >
        <div  className="fade" style={{width:"160px",padding:"2px",margin:"20px",textAlign:"center",borderBottom:"2px solid white",paddingTop:"50px",position:"relative",left:"10px"}}>
            ...
            <div className="center column fade link" style={{scale:"2",margin:"20px",marginBottom:"150px",position:"relative",left:"36px"}} >
                ...
                <div className="about" style={{width:"200px",color:"white",fontSize:"15px",marginTop:"10px",cursor:"pointer",position:"relative",right:"2px"}} >An online bookstore where you can browse and preview books for free.</div>
            </div>
