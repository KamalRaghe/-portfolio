  ...
  return (
    <div className="center column" style={{fontSize:"25px",fontWeight:"bolder"}} >
        ...
        <div  className="fade" style={{width:"160px",padding:"2px",margin:"20px",textAlign:"center",borderBottom:"2px solid white",paddingTop:"50px"}}>
            ...
            <div className="center fade glow" style={{scale:"2",margin:"40px",marginBottom:"130px",position:"relative",left:"29px"}} >
                <Pic title = {""} pic ={'pic1.png'} top={'38px'} small={true} ></Pic>
            </div>
            <div className="center fade glow" style={{scale:"2",margin:"20px",marginBottom:"150px",position:"relative",left:"29px"}} >
                <Pic title = {""} pic ={'pic2.png'} top={'38px'} small={true} ></Pic>
            </div>
            <div className="center fade glow" style={{scale:"2",marginBottom:"150px",position:"relative",left:"29px"}} >
